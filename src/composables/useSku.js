...
import { createGoodsSkusCard, updateGoodsSkusCard, deleteGoodsSkusCard, sorcGoodsSkusCard, createGoodsSkusCardValue, updateGoodsSkusCardValue, deleteGoodsSkusCardValue, chooseAndSetGoodsSkusCard } from '~/api/goods.js'
import { useArrayMoveUp, useArrayMoveDown,cartesianProductOf } from '~/composables/utils'
//商品ID
...
//选择设置规格
export function chooseSetGoodsSkuCard(id, data) {
