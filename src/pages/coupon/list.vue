        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="操作" width="250" align="center">
                <template #default="scope">
                    ...
                    <el-popconfirm v-if="scope.row.statusText != '领取中'" title="是否要删除该优惠券?" confirm-button-text="确认" cancel-button-text="取消"
                    ...
                    <el-popconfirm v-if="scope.row.statusText == '领取中'" title="是否让该优惠券失效?" confirm-button-text="失效" cancel-button-text="取消"
                        @confirm="handleStatusChange(0,scope.row)">
                        <template #reference>
                            <el-button type="danger" size="small">失效
                            </el-button>
                        </template>
                    </el-popconfirm>
                </template>
