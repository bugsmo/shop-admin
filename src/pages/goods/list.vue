    ...
    <div>
        ...
        <el-card shadow="never" class="border-0">
            ...
            <ListHeader layout="create,refresh" @create="handleCreate" @refresh="getData">
                ...
                <el-popconfirm v-if="searchForm.tab=='delete'" title="是否彻底删除商品?" confirm-button-text="确认" cancel-button-text="取消"
            ...
            <el-table ref="multipleTableRef" @selection-change="handleSelectionChange" :data="tableData" stripe
                    ...
                    <template #default="{ row }">
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-500 text-xs mb-1">分类:{{row.category ? row.category.name : "未分类"}}
                                </p>
                                <p class="text-gray-500 text-xs">创建时间:{{row.create_time}}</p>
                            </div>
                        </div>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="总销量" width="90" prop="stock" align="center"></el-table-column>
                <el-table-column label="操作" align="center">
                    <template #default="scope">
                        <div v-if="searchForm.tab != 'delete'">
                            ...
                            size="small" text @click="handleSetGoodsSkus(scope.row)" :loading="scope.row.skusLoading">商品规格</el-button>
            ...
            <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
                <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
                    <el-form-item label="商品名称" prop="title">
                        <el-input v-model="form.title" placeholder="请输入商品名称，最长不超过60个字符"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="商品描述" prop="desc">
                        <el-input type="textarea" row="5" v-model="form.desc" placeholder="选填，商品卖点"></el-input>
                    </el-form-item>
                    <el-form-item label="单位" prop="unit">
                        <el-input v-model="form.unit" placeholder="请输入单位" style="width:30%;"></el-input>
                    </el-form-item>
                    <el-form-item label="总库存" prop="stock">
                        <el-input v-model="form.stock" style="width:30%;">
                            <template #append>件</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="库存预警" prop="min_stock">
                        <el-input v-model="form.min_stock" style="width:30%;">
                            <template #append>件</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="最低销售价" prop="min_price">
                        <el-input v-model="form.min_price" style="width:30%;">
                            <template #append>元</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="最低原价" prop="min_oprice">
                        <el-input v-model="form.min_oprice" style="width:30%;">
                            <template #append>元</template>
                        </el-input>
                    </el-form-item>
...
import { getGoodsList, updateGoodsStatus, createGoods, updateGoods, deleteGoods,restoreGoods,destroyGoods } from '~/api/goods.js';
...
const handleRestoreGoods = ()=>{
    useMutilAction(restoreGoods,"恢复")
}

const handleDestroyGoods = ()=>{
    useMutilAction(destroyGoods,"彻底删除")
}

function useMutilAction(func,msg){
    loading.value = true
