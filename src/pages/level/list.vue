        ...
        <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
            <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
                ...
                <el-form-item label="升级条件">
                    <div>
                        <small class="text-sm mr-2">累计次数满</small>
                    ...
                    <div>
                        ...
                        <small class="text-gray-400 flex">
                            设置会员等级所需要的购买量必须大于0，单位：笔
                        </small>
                    </div>
                </el-form-item>
                <el-form-item label="折扣率(%)" prop="discount">
                    <el-input v-model="form.level" placeholder="折扣率(%)" type="number" style="width:50%;">
                        <template #append>%</template>
                    </el-input>
                    <small class="text-gray-400 flex">
...
const {
    ...
    rules: {
        name: [
            { required: true, message: '会员等级名称必填', trigger: 'blur' }
        ]
    }
})
