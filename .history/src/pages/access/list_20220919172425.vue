        ...
        <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
            <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
                <el-form-item label="上级菜单" prop="rule_id">
                    <el-cascader v-model="form.rule_id" :options="options" :props="{label:'name',children: 'child',checkStrictly:
                    true,emitPath:false}" clearable />
                </el-form-item>
                <el-form-item label="菜单/规则" prop="menu">
                    <el-radio-group v-model="form.menu">
                        <el-radio label="1">菜单</el-radio>
                        <el-radio label="2">规则</el-radio>
                    </el-radio-group>
                </el-form-item>
                ...
                <el-form-item label="请求方式" prop="method">
                    <el-select v-model="form.method" class="m-2" placeholder="请选择请求方式">
                        <el-option v-for="item in ['GET','POST','DELETE','PUT']" :key="item.value" :label="item.label" :value="item.value" />
                    </el-select>
                </el-form-item>
