            ...
            <Search :model="searchForm" @search="getData" @reset="resetSearchForm">
                ...
                <template #show>
                    ...
                    <SearchItem label="手机号">
                        <el-input v-model="searchForm.no" placeholder="手机号" clearable></el-input>
                    </SearchItem>
                    <SearchItem label="开始时间">
                        <el-input v-model="searchForm.no" placeholder="开始时间" clearable></el-input>
                    </SearchItem>
                    <SearchItem label="结束时间">
                        <el-input v-model="searchForm.no" placeholder="结束时间" clearable></el-input>
                    </SearchItem>
                </template>
            </Search>
