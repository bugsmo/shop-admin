        ...
        <el-card v-if="info.ship_data" shadow="never" class="mb-3">
            ...
            <el-form label-width="80px">
                ...
                <el-form-item label="运单号">
                    ...
                    <el-button type="primary" text @click="openShipInfoModalRef(info.id)" class="ml-3" size="small"></el-button>
...
const ShipInfoModalRef = ref(nul)
const openShipInfoModalRef = (id)=>{
