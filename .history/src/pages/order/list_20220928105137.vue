            ...
            <Search :model="searchForm" @search="getData" @reset="resetSearchForm">
                ...
                <template #show>
                    ...
                    <SearchItem label="开始时间">
                        <el-date-picker v-model="searchForm.starttime" type="year" size="normal" placeholder="选择日期时间">
                        </el-date-picker>
                    </SearchItem>
                    <SearchItem label="结束时间">
                        <el-date-picker v-model="searchForm.endtime" type="year" size="normal" placeholder="选择日期时间">
                        </el-date-picker>
                    </SearchItem>
                </template>
            </Search>
