        ...
        <el-form :model="form" label-width="160px">
            ...
            <el-form-item label="一级返佣比例">
                <div>
                    ...
                    <small class="text-gray-500 flex mt-1">订单交易成功后给上级返佣的比例0 - 100，例如5 = 返订单金额的5%</small>
                </div>
            </el-form-item>
            ...
            <el-form-item label="自购返佣">
                <div>
                    ...
                    <small
                        class="text-gray-500 flex mt-1">是否开启自购返佣（开启：分销员自己购买商品，享受一级返佣，上级享受二级返佣；关闭：分销员自己购买的商品没有返佣）</small>
                </div>
            </el-form-item>
            ...
            <el-form-item label="结算时间">
                <div>
                    <el-input v-model="form.settlement_days" placeholder="结算时间" style="width:30%;" type="number">
            ...
            <el-form-item label="佣金到账方式">
                <div>
                    ...
                    <small class="text-gray-500 flex mt-1">是否开启自购返佣（开启：分销员自己购买商品，享受一级返佣，上级享受二级返佣；关闭：分销员自己购买的商品没有返佣）</small>
                </div>
            </el-form-item>
