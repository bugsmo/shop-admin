<template>
    ...
    <el-card shadow="never" class="border-0">
        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="推广用户数量" prop="" align="center" />
            <el-table-column label="订单数量" prop="" align="center" />
            <el-table-column label="订单金额" prop="" align="center" />
            <el-table-column label="账户佣金" prop="" align="center" />
            <el-table-column label="已提现金额" prop="" align="center" />
            <el-table-column label="提现次数" prop="" align="center" />
            <el-table-column label="未提现金额" prop="" align="center" />
