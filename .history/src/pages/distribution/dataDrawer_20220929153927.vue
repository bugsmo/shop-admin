<template>
    <el-drawer title="推广人信息" v-model="dialogVisible" size="70%">
        ...
        <el-form :model="searchForm" :size="small">
            <el-form-item label="时间选择" v-model="searchForm.type">
            ...
            <el-form-item label="用户类型">
                <el-form-item label="用户类型" v-model="searchForm.level">
                    <el-radio-button label="all">全部</el-radio-button>
                    <el-radio-button label="today">今天</el-radio-button>
                    <el-radio-button label="yesterday">昨天</el-radio-button>
                    <el-radio-button label="last7days">最近7天</el-radio-button>
        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            ...
            <el-table-column fixed="right" label="操作" width="180" align="center">
                <template #default="{ row }">
                    <el-button type="primary" size="small" text @click="openDataDrawer(row.id)">推广人</el-button>
